...
class Cart
{
    ...
    {
        return array_map(static fn (QuantifiedProduct $quantifiedProduct) => $quantifiedProduct->getProduct(), $this->getQuantifiedProducts());
    }
    ...
    {
        return $this->promoCodes->exists(static function ($key, PromoCode $promoCode) use ($promoCodeCode) {
