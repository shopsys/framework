...
class Flag extends AbstractTranslatableEntity
{
    ...
    {
        /** @var \Shopsys\FrameworkBundle\Model\Product\Flag\FlagTranslation $flagTranslation */
        $flagTranslation = $this->translation($locale);
        return $flagTranslation->getName();
    }
